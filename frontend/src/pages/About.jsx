        ...
        <section className="px-6 md:px-20 py-24 bg-white dark:bg-slate-900/50">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="group">
                <div className="aspect-[4/5] overflow-hidden rounded-xl mb-4">
                  <img alt="Elena Rodriguez" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCjycyLaPPRf-W5pii70xd9U247jh7k-XhrAJ0oKXzhDzDR7sEUWZ8k7vlJuF1-OaMoiLHhDpIoPh8urOLrX91u9zMi9-ddWULGAKT3CbH0YFNT5pc_kc4jquUFvPhCiwpZyg2FEyOkLxeqj8zomGM8y-SXZnDRbDWqfbiud9mF4uXq5ovT6f72fTZ9V-TEedNGBVGL285UY4nSgD3fwIicazMk6SPp-nJKIvVtiLKucN5HbrnbAlNxIWXGksrI_KkQBHtoRUtcinMa" />
                </div>
              ...
              <div className="group">
                <div className="aspect-[4/5] overflow-hidden rounded-xl mb-4">
                  <img alt="David Park" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAGLy0eDThDbyQMUoSgb29rcLRZbl2yo5Jqc2oGs6_locbBN76WAdzT5z49DLo7td2CPCmPWXlhqnNg4kwXqRkp_-siJZmZXhMKX0UysTrCN1F4jA75PVORQZcp9cdIYR1gY_Cr5sybqKvVR77ZPWRWo6sC49XSjgD4iEi8_XWSO9Bdx2tQ-UDdWmLITuEzj975QLJlL1olCcv8RWQUQhTdycVoT3axO6LTYhxopRw2leeRKGTTqT-bctwywu4bXNYxqIsWoa10VoSX" />
                </div>
