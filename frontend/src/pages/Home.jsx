                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="product-card bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-700 group transition-all">
                            <div className="relative overflow-hidden aspect-square">
                                <img alt="Lime Zest Fizz" loading="lazy" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCV55y0YHzvSDkFxLyDuFwDwO1BgXxu5-6koZusgyq31rmq7cKKENz5cZJ5hzlz5nOa7wpSy8zZkKDF5JAfxBy6P9aMp2yhdplF7DC-jaq9GLl6kUZbn9UWt1f1uFSCHOF0PZLbmnX2TkWhEdyN6juMnOFfRAAZXWjBNhwPRHFlxYQEpFpBvqS8W8IU2TP31YBNOxFE_IeJGh-pgplPrJPTCqmb6RIwCPWNVC6yXFwOljQ_Z4yPWotRYptTaLWGApeV_F8kdVCm1Bbm" />
                        ...
                        <div className="product-card bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-700 group transition-all">
                            <div className="relative overflow-hidden aspect-square">
                                <img alt="Berry Bliss Fizz" loading="lazy" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA-h_rwVmBqr4HyXVx4v3pMsxKg9TvRbi6qUcNLyMU1cg5u9fUOGc9EOwjhJCTAUubTXXlTzLUNNuzhiBmE_xiP-CX9JOWbFiRI_HBAojZnvLpkC-b5vU8lOqnpVZKc0HFJlr7bcV5tyrUIzgAhHW7bhXmFrzCyL8RfYkENPyEXWmRHLUbeLbpcrYS0mmxHogGF5Dgbhb-CwfaHdaq0ZSrNQdgROI4yczKrnOznzWil8Sn2aKLG7pfHq_2_RNA-scrNj5gHJBEFtPUM" />
                            </div>
                            <div className="p-6">
                                <div className="flex items-center gap-1 mb-2">
                                    <span className="material-symbols-outlined text-yellow-400 text-sm fill-current">star</span>
                        ...
                        <div className="product-card bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-700 group transition-all">
                            <div className="relative overflow-hidden aspect-square">
                                <img alt="Variety Pack" loading="lazy" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBl18XUZ3jT3jPmXTpsipMcH_-oIPUEqyTjOMv4gXMAeAkKrArlT1WSdn7orv5raMSUSJ196NCHyAtlNg8Re25yOwZcb9KwMM7wkS22YNcDFi13YEaArp8qFSAJ73s9kk7h27Mr-qdoZniyRoJ7Zy_KQ7KJRISigFhDWljEudg0PTQ2_YEJLEoZvAdPHft-soyC13Hmvf_38XYQlJkppCWDBbg5HiUGEXzaLQvx9qgu-4b8Z2kX0pFciu4qZ_5vculDCYkFW9vZpuRo" />
